      ...
      <div className="relative min-h-screen w-screen overflow-hidden bg-background">
        ...
        <footer className="relative z-10 px-4 md:px-12 py-6 md:py-8 border-t border-border/50">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
            ...
            <a 
              href="https://www.instagram.com/bookthreadsapp?igsh=YmJ4cXViNmRnMDkw" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 hover:from-pink-500/30 hover:to-purple-500/30 transition-all group"
            >
              <svg className="w-4 h-4 text-pink-400 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="text-xs md:text-sm text-pink-400 font-medium">@bookthreadsapp</span>
            </a>
