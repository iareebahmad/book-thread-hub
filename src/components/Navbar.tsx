...
import { BookOpen, LogOut, Heart, Settings, Menu, CreditCard, Calendar, User, Shield, Search, X } from 'lucide-react';
    ...
    <nav className="border-b border-border/50 bg-card/60 backdrop-blur-xl sticky top-0 z-50 glow">
        ...
        {user && (
          <div className="flex items-center gap-1.5">
            ...
            <UserSearchAutocomplete 
              ...
              inputClassName="w-48 lg:w-64 h-9 bg-secondary/50 border-border/50 rounded-full text-sm focus:w-72 transition-all duration-300"
            />
      ...
      {user && showMobileSearch && (
        <div className="md:hidden border-t border-border/30 px-4 py-3 bg-card/80">
          <UserSearchAutocomplete 
            inputClassName="w-full h-10 bg-secondary/50 border-border/50 rounded-full"
